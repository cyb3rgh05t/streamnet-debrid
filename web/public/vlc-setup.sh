#!/usr/bin/env bash
# StreamNet - Enable "Open in VLC" protocol handler for Linux
set -e

echo "================================================"
echo " StreamNet - Enable \"Open in VLC\" for Linux"
echo "================================================"
echo ""
...
SCRIPT_PATH="$BIN_DIR/streamnet-vlc"
...
[Desktop Entry]
Name=VLC StreamNet Link Handler
