...
fun tr(text: String): String {
    ...
    @StringRes val resId: Int? = when (text.trim()) {
        ...
        "StreamNet uses community streaming addons to find video sources. Without at least one streaming addon, content cannot be played." -> R.string.no_results
...
private object AppLanguageRegexes {
    ...
    private fun commonUi(
        ...
        "ARVIO Cloud" to "StreamNet Cloud",
        "StreamNet Cloud" to "StreamNet Cloud",
        ...
        "StreamNet uses community streaming addons to find video sources. Without at least one streaming addon, content cannot be played." to noResults,
