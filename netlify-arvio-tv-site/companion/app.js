// ── Supabase Config ───────────────────────────────────────────────────────
const SUPABASE_URL = "https://szhgwypqzjmoyvrkcjto.supabase.co";
const SUPABASE_ANON =
  "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InN6aGd3eXBxemptb3l2cmtjanRvIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODQ2NzUxOTMsImV4cCI6MjEwMDI1MTE5M30.Pox6SjgVaEGB9ETs7gWyXsISde7PpsJJmyaaA-soIV4";
...
const STRINGS = {
  en: {
    ...
    no_sync: "No sync data",
    // auth
    auth_sub:
      "Manage your StreamNet account — profiles, add-ons, history & AI subtitles",
    auth_google: "Continue with Google",
    // dashboard
    dash_sub: "A quick overview of your StreamNet account",
    stat_profiles: "Profiles",
    stat_addons: "Add-ons",
    stat_history: "Watch History",
    ...
    profiles_empty:
      "No profiles found — open StreamNet TV on your TV to create one",
    profiles_tip:
      "💡 Profile management (create, delete, rename) is available in StreamNet TV on your TV.<br>Changes sync automatically to the cloud.",
    badge_active: "Active",
    badge_kids: "Kids",
    badge_locked: "🔒 Locked",
    // addons
    ...
    addons_tip:
      "💡 To add or remove add-ons, go to Settings in StreamNet TV on your TV. Data syncs automatically.",
    badge_official: "Official",
    badge_subtitles: "Subtitles",
    ...
    iptv_empty:
      "No IPTV playlists configured — go to StreamNet TV → Settings → IPTV",
    iptv_m3u: "M3U Playlists",
    iptv_active: "Active",
    iptv_disabled: "Disabled",
    fav_groups: (n) => `Favourite Groups (${n})`,
    fav_channels: (n) => `Favourite Channels (${n})`,
    iptv_more: (n) => `+${n} more`,
    iptv_tip:
      "💡 To add M3U playlists and manage channels — go to IPTV Settings in StreamNet TV. Changes sync automatically to the cloud.",
    // plugins
    plugins_title: "Plugins (Sideload)",
    plugins_sub: (r, s) =>
      `${r} repositor${r !== 1 ? "ies" : "y"} · ${s} scrapers`,
    plugins_status_on: "Plugins enabled",
    plugins_status_off: "Plugins disabled",
    plugins_empty:
      "No plugin repositories — add one in ARVIO → Settings → Plugins",
    ...
    tab_tv: "TV Shows",
    tab_all: "All",
    history_empty: "No watch history",
    history_err: "Failed to load",
    delete_err: "Failed to delete",
    deleted_history: "Removed from history ✓",
    // watchlist
    ...
    wl_tv: "📺 TV Shows",
    wl_remove: "Remove",
    wl_remove_err: "Failed to remove",
    ...
    ai_banner_sub:
      "For security, your API key is stored locally on your TV only.<br>Open ARVIO → Settings → Subtitles → AI Translation",
    ai_settings_title: "Translation Settings",
    ai_enable: "Enable AI Translation",
    ai_enable_desc: "Automatically translate subtitles while watching",
    ai_auto: "Auto-select",
    ai_auto_desc: "Automatically pick subtitles for translation",
    ai_hi: "Remove Hearing Impaired (HI)",
    ai_hi_desc: "Strip audio descriptions from subtitles [SDH]",
    ...
    ai_key_desc:
      "🔹 <b>Groq (recommended)</b>: go to <code>console.groq.com</code> → Create account → API Keys → Create Key<br>🔹 <b>Gemini</b>: go to <code>aistudio.google.com</code> → Get API Key",
    ai_recommended: "Recommended",
    // settings
    settings_title: "Settings",
    settings_sub: "General account settings",
    appearance: "Appearance",
    oled_label: "OLED Black Background",
    oled_desc: "Pure black background to save battery on OLED screens",
    layout_label: "Media Card Layout",
    layout_landscape: "Landscape",
    layout_portrait: "Portrait",
    lang_label: "App Language",
    profile_section: "Profile",
    skip_label: "Skip Profile Selection",
    skip_desc: "Launch directly into the app with the active profile",
  ...
  he: {
    ...
    nav_addons: "הרחבות",
    nav_iptv: "IPTV",
    nav_plugins: "פלאגינים",
    nav_history: "היסטוריה",
    nav_watchlist: "רשימת צפייה",
    nav_ai: "כתוביות AI",
    nav_settings: "הגדרות",
    sign_out: "התנתק",
    user_fallback: "משתמש",
    loading: "טוען...",
    saved: "נשמר ✓",
    save_err: "שגיאה בשמירה",
    no_sync: "אין נתוני סנכרון",
    // auth
    ...
    stat_profiles: "פרופילים",
    stat_addons: "הרחבות",
    stat_history: "היסטוריית צפייה",
    stat_watchlist: "רשימת צפייה",
    ...
    profiles_tip:
      "💡 ניהול פרופילים (יצירה, מחיקה, שינוי שם) זמין ב-ARVIO על הטלוויזיה.<br>שינויים מסונכרנים אוטומטית עם הענן.",
    badge_active: "פעיל",
    badge_kids: "ילדים",
    badge_locked: "🔒 נעול",
    // addons
    ...
    badge_official: "רשמי",
    badge_subtitles: "כתוביות",
    badge_metadata: "מטאדאטה",
    badge_community: "קהילה",
    badge_telegram: "Telegram",
    badge_enabled: "פעיל",
    badge_disabled: "כבוי",
    ...
    plugins_status_on: "פלאגינים פעילים",
    plugins_status_off: "פלאגינים כבויים",
    ...
    tab_tv: "סדרות",
    tab_all: "הכל",
    history_empty: "אין היסטוריית צפייה",
    history_err: "שגיאה בטעינה",
    delete_err: "שגיאה במחיקה",
    deleted_history: "הוסר מההיסטוריה ✓",
    // watchlist
    ...
    ai_banner_sub:
      "מטעמי אבטחה, מפתח ה-API נשמר רק מקומית בטלוויזיה.<br>פתח את ARVIO ← הגדרות ← כתוביות ← תרגום AI",
    ai_settings_title: "הגדרות תרגום",
    ai_enable: "הפעל תרגום AI",
    ai_enable_desc: "תרגם כתוביות אוטומטית בזמן צפייה",
    ai_auto: "בחירה אוטומטית",
    ai_auto_desc: "בחר אוטומטית כתוביות לתרגום",
    ai_hi: "הסר כתוביות לכבדי שמיעה",
    ai_hi_desc: "הסר תיאורי קול מהכתוביות [SDH]",
    ...
    ai_key_desc:
      "🔹 <b>Groq (מומלץ)</b>: גש ל-<code>console.groq.com</code> ← צור חשבון ← API Keys ← Create Key<br>🔹 <b>Gemini</b>: גש ל-<code>aistudio.google.com</code> ← Get API Key",
    ai_recommended: "מומלץ",
    // settings
    settings_title: "הגדרות",
    settings_sub: "הגדרות כלליות לחשבון",
    appearance: "מראה",
    oled_label: "רקע OLED שחור",
    oled_desc: "רקע שחור לחלוטין לחיסכון בסוללה",
    layout_label: "פריסת כרטיסי מדיה",
    layout_landscape: "Landscape (רוחב)",
    layout_portrait: "Portrait (אנכי)",
    lang_label: "שפת ממשק",
    profile_section: "פרופיל",
    skip_label: "דלג על בחירת פרופיל",
    skip_desc: "עבור ישירות לאפליקציה עם הפרופיל הפעיל",
    account_section: "חשבון",
    user_id_label: "מזהה משתמש",
    // time
    just_now: "עכשיו",
    m_ago: (m) => `לפני ${m} דק׳`,
    h_ago: (h) => `לפני ${h} שע׳`,
...
function setLang(lang) {
  ...
  if (authBtn)
    authBtn.childNodes[authBtn.childNodes.length - 1].textContent =
      " " + t("auth_google");
...
async function saveSyncPayload(payload) {
  ...
  let wrapper = {};
  try {
    wrapper = JSON.parse(existing?.addons ?? "{}");
  } catch {}
...
async function renderDashboard() {
  ...
  const [histRes, wlRes] = await Promise.all([
    db
      .from("watch_history")
      .select("id, media_type", { count: "exact", head: false })
  ...
  const { data: recent } = await db
    .from("watch_history")
    .select(
      "title, media_type, progress, updated_at, poster_path, backdrop_path",
    )
    .eq("user_id", state.userId)
...
async function renderAddons() {
  ...
  function addonIcon(a) {
    ...
    if (logo)
      return `<img src="${logo}" alt="" onerror="this.style.display='none'">`;
  ...
  function addonTypeBadge(a) {
    ...
    if (t === "OFFICIAL")
      return `<span class="badge badge-gold">${STRINGS[currentLang].badge_official}</span>`;
    if (t === "SUBTITLE")
      return `<span class="badge badge-blue">${STRINGS[currentLang].badge_subtitles}</span>`;
    if (t === "METADATA")
      return `<span class="badge badge-gray">${STRINGS[currentLang].badge_metadata}</span>`;
    if (a.runtimeKind === "TELEGRAM")
      return `<span class="badge badge-blue">${STRINGS[currentLang].badge_telegram}</span>`;
...
async function renderIPTV() {
  ...
  for (const [profileId, iptvState] of Object.entries(iptvByProfile)) {
    ...
    if (iptvState.m3uUrl && !seenUrls.has(iptvState.m3uUrl)) {
      ...
      allPlaylists.push({
        id: "legacy",
        name: "M3U",
        m3uUrl: iptvState.m3uUrl,
        epgUrl: iptvState.epgUrl,
        enabled: true,
        _profileName: pName,
        _profileId: profileId,
      });
  ...
  const activeIPTV =
    iptvByProfile[activeId] ?? Object.values(iptvByProfile)[0] ?? {};
  ...
  main.innerHTML = `
    ...
    <div class="card" style="padding:14px 20px;display:flex;flex-wrap:wrap;gap:8px">
      ${favChannels
        .slice(0, 50)
        .map((c) => `<span class="badge badge-blue">📺 ${escapeHtml(c)}</span>`)
        .join("")}
...
async function renderHistoryContent() {
  document.querySelectorAll(".tab").forEach((tab) => {
    ...
    tab.classList.toggle(
      "active",
      tab.textContent.trim() === map[state.historyTab],
    );
  });
  ...
  if (error) {
    el.innerHTML = `<div class="empty"><div class="empty-title">${t("history_err")}</div></div>`;
    return;
  }
  if (!data?.length) {
    el.innerHTML = emptyState(t("history_empty"));
    return;
  }
...
function buildShell(user) {
  const name =
    user.user_metadata?.full_name || user.email || t("user_fallback");
  ...
  const navItems = [
    ...
    },
    {
      id: "addons",
      label: t("nav_addons"),
      icon: '<rect x="3" y="3" width="18" height="18" rx="3"/><path d="M9 9h6M9 12h6M9 15h4"/>',
    },
    {
      id: "iptv",
      label: "IPTV",
    ...
    },
    {
      id: "ai",
      label: t("nav_ai"),
      icon: '<path d="M12 2a3 3 0 013 3v7a3 3 0 01-6 0V5a3 3 0 013-3z"/><path d="M19 10v2a7 7 0 01-14 0v-2"/><line x1="12" y1="19" x2="12" y2="23"/><line x1="8" y1="23" x2="16" y2="23"/>',
    },
    {
      id: "settings",
      label: t("nav_settings"),
      icon: '<circle cx="12" cy="12" r="3"/><path d="M19.07 4.93l-1.41 1.41M4.93 4.93l1.41 1.41M19.07 19.07l-1.41-1.41M4.93 19.07l1.41-1.41M1 12h2M21 12h2M12 1v2M12 21v2"/>',
    },
  ];
